...
if (instance_exists(oSpellObject) && oTurnController.previousTurn = "oPlayer") {
	sprite_index = castSprite;
	image_speed  = 0;
}

currentEnemy = oCombatPlayer2;
	
// If hit by spell
if (place_meeting(x, y, oSpellObject) && oTurnController.previousTurn != "oPlayer") {
	hurt = true;
	if (!playedHurtSound) {
